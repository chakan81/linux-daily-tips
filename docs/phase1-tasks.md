...
**프론트엔드 초기화**
- [ ] Next.js 15 프로젝트 생성 (App Router) → **frontend-code-writer**
- [ ] Turbopack 설정 및 최적화 → **frontend-code-writer**
- [ ] TypeScript 설정 및 엄격 모드 활성화 → **frontend-code-writer**
- [ ] Tailwind CSS 설정 및 커스텀 테마 구성 → **frontend-code-writer**

**완료 기준**: `npm run dev` 실행 시 < 2초 Hot Reload 달성

#### Day 5-6: shadcn/ui 통합 및 기본 컴포넌트
**UI 시스템 구축**
- [ ] shadcn/ui 설치 및 설정 → **ui-ux-designer + frontend-code-writer**
- [ ] 기본 컴포넌트 설치 (Button, Card, Input, Layout) → **ui-ux-designer**
...
- [ ] Python 3.12 가상환경 및 의존성 관리 → **backend-code-writer**
...
### 🚩 Week 1 마일스톤
**검증 항목**
- [ ] Next.js 15 + shadcn/ui 기본 페이지 렌더링
